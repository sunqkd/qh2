<template>
	<div class="homePage">
		...
		<div class="homeBody">
			...
			<div class="roadProject">
				<ul>
					<li>u致力于为建设开发全周期提供AI解决方案与决策管理的科技公司</li>
					<li class="disc">
						<div>
			...
			<div class="roadProject">
				<ul>
					<li>移动化开发服务平台</li>
					<li>公司是一家专注于智慧应急、人工智能和特种工况领域的物联网科技公司，总部位于广州。基于在AI人工智能和大数据引擎的核心技术沉淀，星伦能为政府和企业客户提供智慧平台的顶层咨询规划、开发、实施与综合运营服务。我们立足于自主创新，持续研发；依托专业团队，提供满足客户需求的软件和硬件品解决方案和系统集成方案。星伦物联以英国皇家工程院院士，帝国理工学院终身教授、帝国理工学院数据科学研究所团队为核心，加上百度算法研究中心和华为2012实验室等多位人工智能专家，经多年持续投入研发和积累，获得多项知识产权，专注于打造城市应急全场景的物联网方案，为客户和社会提供优质应急管理服务。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>工业物联网解决方案提供商</li>
					<li>公司为工业物联网平台供应商，提供行业垂直化的云解决方案！技术 创新：提供工业物联网整套云平台软硬件解决方案，解决能源环保行业设备远程监控和运维的效率 低，成本高的痛点问题！商业模式：设备运维垂直Saas化平台服务+设备采集硬件+设备服务费。团 队优势：出身电力巨头和汽车自动化巨头的研发团队，可支持技术的不停迭代优势。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
...
export default {
	data () {
		return {
			...
			decs:'路演时间：10月22日14:00 路演地点：前海深港青年梦工场 智汇全球·追梦前海>>',
